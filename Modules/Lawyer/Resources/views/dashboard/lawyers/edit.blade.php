...
@section('title', __('lawyer::dashboard.lawyers.update.title'))
@section('content')
  ...
  <div class="page-content">
    <div class="page-bar">
      <ul class="page-breadcrumb">
        ...
        <li>
          <a href="#">{{__('lawyer::dashboard.lawyers.update.title')}}</a>
        </li>
      </ul>
    </div>
    ...
    <div class="row">
      {!! Form::model($model,[
      'url'=> route('dashboard.lawyers.update',$model->id),
      'id'=>'updateForm',
      'role'=>'form',
      'method'=>'PUT',
                  ...
                  <ul class="nav nav-pills nav-stacked">
                    <li class="active">
                      <a href="#global_setting"
                        data-toggle="tab">
                        {{ __('lawyer::dashboard.lawyers.update.form.general') }}
                      </a>
                    </li>
                    <li class="">
                      <a href="#profile"
