...
{!! field()->select('country_id',__('projects::dashboard.projects.form.country') ,
pluckModelsCols($countries->get(),'title','id',true)) !!}
{!! field()->multiSelect('categories',__('projects::dashboard.projects.form.categories') ,
pluckModelsCols($categories->get(),'title','id',true)) !!}
