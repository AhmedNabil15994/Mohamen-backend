...
// }
// Active Dashboard Menu
if (!function_exists('active_current_route_name')) {
    function active_current_route_name($routeName)
    {
...
if (!function_exists('getDays')) {
    ...
    {
        $days = __('club::dashboard.clubs.form.days');
        return   $dayCode ? $days[$dayCode] : $days;
    }
}


if (!function_exists('getDayCode')) {
