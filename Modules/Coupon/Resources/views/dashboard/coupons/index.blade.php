...
@section('title', __('coupon::dashboard.coupons.routes.index'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('coupon::dashboard.coupons.routes.index')}}</a>
                </li>
            </ul>
        </div>
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{ url(route('dashboard.coupons.create')) }}"
                        ...
                        <table class="table table-striped table-bordered table-hover"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>{{__('coupon::dashboard.coupons.datatable.amount')}}</th>
                                    <th>{{__('coupon::dashboard.coupons.datatable.is_fixed')}}</th>
                                    <th>{{__('coupon::dashboard.coupons.datatable.current_use')}}</th>
                    ...
                    <div class="row">
                        <div class="form-group">
                            <button type="submit"
                                ...
                                onclick="deleteAllChecked('{{ url(route('dashboard.coupons.deletes')) }}')">
...
<script>
    function tableGenerate(data='') {
      ...
      $('#dataTable').DataTable({
          ajax : {
              url   : "{{ url(route('dashboard.coupons.datatable')) }}",
              type  : "GET",
              data  : {
                  req : data,
              },
          ...
          columns: [
            ...
            {data: 'expired_at' 	      , className: 'dt-center'},
            {data: 'amount' 	        , className: 'dt-center'},
            { data: "is_fixed" ,orderable: false , width: "1%",
            ...
            {data:"current_use" , className: 'dt-center'},
 ...
 responsivePriority:1,
              ...
              render: function(data, type, full, meta) {
                ...
                // Edit
      					var editUrl = '{{ route("dashboard.coupons.edit", ":id") }}';
      					editUrl = editUrl.replace(':id', data);

      					// Delete
      					var deleteUrl = '{{ route("dashboard.coupons.destroy", ":id") }}';
