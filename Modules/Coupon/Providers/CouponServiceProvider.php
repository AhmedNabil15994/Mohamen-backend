...
use Modules\Coupon\Enum\SubscriptionType;
use Illuminate\Database\Eloquent\Factory;
use Modules\Coupon\Console\CheckExpiredAds;
use Modules\Coupon\Console\CheckPublishAds;
use Illuminate\Database\Eloquent\Relations\Relation;
use Modules\Core\Packages\Payment\KnetPaymentService;
use Modules\Coupon\Console\RemoveExpiredAdsAdditionsCommand;
...
class CouponServiceProvider extends ServiceProvider
{
    ...
    protected function registerConfig()
    {
        ...
        $this->mergeConfigFrom(
            module_path('Coupon', 'Config/config.php'),
            'coupon'
        );
    }
