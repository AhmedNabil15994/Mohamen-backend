                                            ...
                                            <div class="md-radio-list">
                                                <div class="md-radio has-success">
                                                    <input type="radio"
                                                        ...
                                                        class="md-radiobtn"
                                                        value="success"
                                                        {{($orderStatus->color_label == 'success') ? ' checked="" ' :
                                                    ''}}>
                                                    <label for="success">
                                                        <span></span>
                                                ...
                                                <div class="md-radio has-warning">
                                                    <input type="radio"
                                                        ...
                                                        class="md-radiobtn"
                                                        value="warning"
                                                        {{($orderStatus->color_label == 'warning') ? ' checked="" ' :
                                                    ''}}>
                                                    <label for="warning">
                                                        <span></span>
                                                        <span class="check"></span>
                                                ...
                                                <div class="md-radio has-error">
                                                    <input type="radio"
                                                        ...
                                                        class="md-radiobtn"
                                                        value="danger"
                                                        {{($orderStatus->color_label == 'danger') ? ' checked="" ' :
                                                    ''}}>
                                                    <label for="error">
                                                        <span></span>
                                                        <span class="check"></span>
                                                ...
                                                <div class="md-radio has-info">
                                                    <input type="radio"
                                                        ...
                                                        class="md-radiobtn"
                                                        value="info"
                                                        {{($orderStatus->color_label == 'info') ? ' checked="" ' : ''}}>
                                                    <label for="info">
                                                        <span></span>
                                                        <span class="check"></span>
                                                        <span class="box"></span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="checkbox"
                                                ...
                                                data-size="small"
                                                name="success_status"
                                                {{($orderStatus->success_status == 1) ? ' checked="" ' : ''}}>
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="checkbox"
                                                ...
                                                data-size="small"
                                                name="failed_status"
                                                {{($orderStatus->failed_status == 1) ? ' checked="" ' : ''}}>
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
