...
@section('title', __('order::dashboard.order_statuses.routes.create'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('order::dashboard.order_statuses.routes.create')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <form id="form"
                ...
                action="{{route('dashboard.order-statuses.store')}}">
                @csrf
                <div class="col-md-12">
