        ...
        <div class="portlet light bordered">
          ...
          <div class="table-toolbar">
            <div class="row">
              <div class="col-md-6">
                <div class="btn-group">
                  <a href="{{ url(route('dashboard.courses.create')) }}"
            ...
            <table class="table table-striped table-bordered table-hover"
              ...
              <thead>
                <tr>
                  ...
                  <th>{{__('course::dashboard.videos.video_status')}}</th>
          ...
          <div class="row">
            <div class="form-group">
              <button type="submit"
                ...
                onclick="deleteAllChecked('{{ url(route('dashboard.courses.deletes')) }}')">
  ...
  function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ url(route('dashboard.courses.datatable')) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },
                    ...
                    columns: [
                        ...
                        {data: 'video_status', className: 'dt-center'},
...
responsivePriority:1,
                            ...
                            render: function (data, type, full, meta) {
                                ...
                                // Edit
                                var editUrl = '{{ route("dashboard.courses.edit", ":id") }}';
                                editUrl = editUrl.replace(':id', data);

                                // Delete
                                var deleteUrl = '{{ route("dashboard.courses.destroy", ":id") }}';
