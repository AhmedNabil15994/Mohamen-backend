...
@section('title', __('course::dashboard.lessons.routes.update'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="{{ url(route('dashboard.lessons.index')) }}">
                        {{__('course::dashboard.lessons.routes.index')}}
                    </a>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
                    <a href="#">{{__('course::dashboard.lessons.routes.update')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            {!! Form::model($model,[
            'url'=> route('dashboard.lessons.update',$model->id),
            'id'=>'updateForm',
            'role'=>'updateForm',
            'method'=>'PUT',
                ...
                <div class="col-md-9">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active fade in"
                            ...
                            <div class="col-md-10">
                                @include('course::dashboard.lessons.form')
                            </div>
                        </div>
