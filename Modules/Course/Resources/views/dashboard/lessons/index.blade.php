...
@section('title', __('course::dashboard.lessons.routes.index'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('course::dashboard.lessons.routes.index')}}</a>
                </li>
            </ul>
        </div>
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{ url(route('dashboard.lessons.create')) }}"
                        ...
                        <table class="table table-striped table-bordered table-hover"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('course::dashboard.lessons.datatable.title')}}</th>
                                    <th>{{__('course::dashboard.lessons.datatable.status')}}</th>
                                    <th>{{__('course::dashboard.lessons.datatable.course')}}</th>
                                    <th>{{__('course::dashboard.lessons.datatable.created_at')}}</th>
                                    <th>{{__('course::dashboard.lessons.datatable.options')}}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
                    <div class="row">
                        <div class="form-group">
                            <button type="submit"
                                ...
                                onclick="deleteAllChecked('{{ url(route('dashboard.lessons.deletes')) }}')">
...
<script>
    function tableGenerate(data='') {
      ...
      $('#dataTable').DataTable({
          ajax : {
              url   : "{{ url(route('dashboard.lessons.datatable')) }}",
              type  : "GET",
              data  : {
                  req : data,
              },
...
responsivePriority:1,
              width: '13%',
              title: '{{__('course::dashboard.lessons.datatable.options')}}',
              className: 'dt-center',
              orderable: false,
              render: function(data, type, full, meta) {

                // Edit
				var editUrl = '{{ route("dashboard.lessons.edit", ":id") }}';
				editUrl = editUrl.replace(':id', data);

				// Delete
				var deleteUrl = '{{ route("dashboard.lessons.destroy", ":id") }}';
