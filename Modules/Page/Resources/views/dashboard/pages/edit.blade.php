    ...
    <div class="page-content">
        ...
        <div class="row">
            <form id="updateForm"
                ...
                action="{{route('dashboard.pages.update',$model->id)}}">
                @csrf
                @method('PUT')
                <div class="col-md-12">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active fade in"
                                ...
                                <div class="col-md-10">
                                        ...
                                        <div class="tab-pane fade in {{ ($code == locale()) ? 'active' : '' }}"
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2">
                                                    {{__('page::dashboard.pages.form.title')}}
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="text"
                                                        name="title[{{$code}}]"
                                                        ...
                                                        value="{{$model->getTranslations('title')[$code]??''}}"
                                                        {{
                                                        (is_rtl($code)=='rtl'
                                                        )
                                                        ? 'dir=rtl'
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('page::dashboard.pages.form.restore')}}
                                        </label>
                                        <div class="col-md-9">
                                            <input type="checkbox"
                                                class="make-switch"
