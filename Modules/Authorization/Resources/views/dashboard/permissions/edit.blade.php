    ...
    <div class="page-content">
        ...
        <div class="row">
            <form id="updateForm"
                ...
                action="{{route('dashboard.permissions.update',$permission->id)}}">
                @csrf
                @method('PUT')
                <div class="col-md-12">
                    <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <textarea name="description[{{$code}}]"
                                                ...
                                                cols="80"
                                                class="form-control"
                                                data-name="description.{{$code}}">{{ $permission->translate($code)? $permission->translate($code)->description : ''}}</textarea>
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    @endforeach
