    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                <li>
                    <a
                      href="{{ url(route('dashboard.home')) }}">{{ __('apps::dashboard.index.title') }}</a>
                </li>
            </ul>
        </div>
                    ...
                    <div class="details">
                        <div class="number">
                            <span data-counter="counterup"
                              data-value="{{$orders_count}}">0</span>
                        </div>
                        <div class="desc">
                            {{ __('apps::dashboard.index.statistics.order_count') }}
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <a class="dashboard-stat dashboard-stat-v2 yellow-lemon" href="#">
                    ...
                    <div class="details">
                        <div class="number">
                            <span data-counter="counterup"
                              data-value="{{$orders_total}}">0</span> KWD
                        </div>
                        <div class="desc">
                            {{ __('apps::dashboard.index.statistics.orders_total') }}
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <a class="dashboard-stat dashboard-stat-v2 blue" href="#">
                    ...
                    <div class="details">
                        <div class="number">
                            <span data-counter="counterup"
                              data-value="{{$countUsers}}">0</span>
                        </div>
                        <div class="desc">
                            {{ __('apps::dashboard.index.statistics.count_users') }}
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <a class="dashboard-stat dashboard-stat-v2 red" href="#">
                    ...
                    <div class="details">
                        <div class="number">
                            <span data-counter="counterup"
                              data-value="{{$completeOrders}}">0</span>
                        </div>
                        <div class="desc">
                            {{ __('apps::dashboard.index.statistics.comleted_orders') }}
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <a class="dashboard-stat dashboard-stat-v2 yellow-casablanca" href="#">
                    ...
                    <div class="details">
                        <div class="number">
                            <span data-counter="counterup"
                              data-value="{{$todayProfit}}">0</span> KWD
                        </div>
                        <div class="desc">
                            {{ __('apps::dashboard.index.statistics.todayProfit') }}
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <a class="dashboard-stat dashboard-stat-v2 yellow-lemon" href="#">
                    ...
                    <div class="details">
                        <div class="number">
                            <span data-counter="counterup"
                              data-value="{{$monthProfit}}">0</span> KWD
                        </div>
                        <div class="desc">
                            {{ __('apps::dashboard.index.statistics.monthProfit') }}
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <a class="dashboard-stat dashboard-stat-v2 yellow-gold" href="#">
                    ...
                    <div class="details">
                        <div class="number">
                            <span data-counter="counterup"
                              data-value="{{$yearProfit}}">0</span> KWD
                        </div>
                        <div class="desc">
                            {{ __('apps::dashboard.index.statistics.yearProfit') }}
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <a class="dashboard-stat dashboard-stat-v2 green" href="#">
                    ...
                    <div class="details">
                        <div class="number">
                            <span data-counter="counterup"
                              data-value="{{$totalProfit}}">0</span> KWD
                        </div>
                        <div class="desc">
                            {{ __('apps::dashboard.index.statistics.total_completed_orders') }}
                        </div>
                    </div>
                </a>
            </div>
                            ...
                            <div class="row">
                                <div class="general-item-list">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <canvas id="myChart2" width="540"
                                          height="270"></canvas>
                                    </div>

                                    <div class="col-md-6">
                                        <b class="page-title">
                                            {{ __('apps::dashboard.index.statistics.orders_monthly') }}
                                            - KWD
                                        </b>
                                        <canvas id="monthlyOrders" width="540"
                                          height="270"></canvas>
                                    </div>
